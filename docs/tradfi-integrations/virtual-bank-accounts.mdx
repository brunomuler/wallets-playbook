...
A user can, for example, receive an ACH transfer using a virtual bank account, receive a USD-pegged stablecoin, then use it directly or withdrwaw it to their local currency.
