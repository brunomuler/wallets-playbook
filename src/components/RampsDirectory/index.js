                            ...
                            <div className={styles.rampHeader}>
                                <div className={styles.rampIdentity}>
                                    ...
                                    <div className={sharedStyles.nameContainer}>
                                        ...
                                        {ramp.website && (
                                            <a href={ramp.website} target="_blank" rel="noopener noreferrer" className={sharedStyles.websiteLink}>
                                                Website
                                                <svg
                            ...
                            {hasContent && (
                                ...
                                {uniqueGeos.length > 0 && (
                                    <div className={styles.detailItem}>
                                        <strong>
                                            <span className="icon-[heroicons--globe-americas]" style={{display: 'inline-block', width: '16px', height: '16px', marginRight: '8px', verticalAlign: 'middle'}}></span>
                                            Geographies
                                        </strong>
                                ...
                                <div className={styles.detailItemContainer}>
                                    {allRampOptions.length > 0 && (
                                        <div className={styles.detailItem}>
                                            <strong>
                                                <span className="icon-[heroicons--arrows-up-down]" style={{display: 'inline-block', width: '16px', height: '16px', marginRight: '8px', verticalAlign: 'middle'}}></span>
                                                Ramp Options
                                            </strong>
                                    ...
                                    {allPaymentMethods.length > 0 && (
                                        <div className={styles.detailItem}>
                                            <strong>
                                                <span className="icon-[heroicons--credit-card]" style={{display: 'inline-block', width: '16px', height: '16px', marginRight: '8px', verticalAlign: 'middle'}}></span>
                                                Payment Methods
                                            </strong>
                                            <div className={styles.assetsList}>
